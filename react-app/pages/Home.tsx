...
export default function Home() {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="relative min-h-[70vh] md:min-h-[85vh] lg:min-h-[90vh] flex items-center overflow-hidden bg-gray-950">
        {/* Background Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black"></div>

        {/* Blurred Hero Background Image */}
        <div className="absolute inset-0 h-[60vh] md:h-full">
          <div
        ...
        {/* Content */}
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 py-20 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

            {/* Left Content */}
            <div className="text-white">
              {/* Top Badge */}
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-sm font-medium mb-6 shadow-sm">
                <Sparkles className="w-4 h-4" />
                Premium Home Design Inspiration
              </div>

              {/* Professional Heading */}
              <h1 className="font-serif text-4xl md:text-5xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight">
                Transform Your Home Into a Masterpiece
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-white"></span>
              </h1>

              {/* Subheading */}
              <p className="text-base md:text-lg lg:text-xl text-white mb-8 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="#rooms"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 rounded-full font-medium hover:bg-gray-200 transition-all shadow-lg hover:shadow-xl"
                >
                  Explore Rooms
                ...
                <a
                  href="#trending"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full font-medium hover:bg-white/20 transition-all"
                >
                  View Products
                </a>
              </div>
